...
```
Starting Nmap 7.94SVN ( https://nmap.org ) at 2024-09-25 21:45 EDT
NSE: Loaded 46 scripts for scanning.
Initiating ARP Ping Scan at 21:45
Scanning 255 hosts [1 port/host]
Completed ARP Ping Scan at 21:46, 3.95s elapsed (255 total hosts)
Initiating Parallel DNS resolution of 3 hosts. at 21:46
Completed Parallel DNS resolution of 3 hosts. at 21:46, 0.06s elapsed
...
Discovered open port 33060/tcp on 192.168.56.101
Discovered open port 49665/tcp on 192.168.56.101
Discovered open port 902/tcp on 192.168.56.101
Discovered open port 49666/tcp on 192.168.56.101
Discovered open port 49671/tcp on 192.168.56.101
Discovered open port 49672/tcp on 192.168.56.101
Discovered open port 912/tcp on 192.168.56.101
Discovered open port 10050/tcp on 192.168.56.101
Discovered open port 49668/tcp on 192.168.56.101
Discovered open port 49664/tcp on 192.168.56.101
Discovered open port 7680/tcp on 192.168.56.101
Completed SYN Stealth Scan against 192.168.56.100 in 25.46s (3 hosts left)
Completed SYN Stealth Scan against 192.168.56.105 in 25.71s (2 hosts left)
Discovered open port 49667/tcp on 192.168.56.101
Discovered open port 5040/tcp on 192.168.56.101
Discovered open port 49669/tcp on 192.168.56.101
Completed SYN Stealth Scan against 192.168.56.101 in 62.29s (1 host left)
Stats: 0:02:59 elapsed; 101 hosts completed (4 up), 4 undergoing SYN Stealth Scan
SYN Stealth Scan Timing: About 98.42% done; ETC: 21:49 (0:00:03 remaining)
Completed SYN Stealth Scan at 21:49, 184.74s elapsed (262140 total ports)
Initiating Service scan at 21:49
Scanning 24 services on 4 hosts
Service scan Timing: About 62.50% done; ETC: 21:50 (0:00:32 remaining)
Completed Service scan at 21:51, 156.42s elapsed (24 services on 4 hosts)
NSE: Script scanning 4 hosts.
Initiating NSE at 21:51
Completed NSE at 21:51, 7.10s elapsed
Initiating NSE at 21:51
Completed NSE at 21:51, 1.05s elapsed
...
MAC Address: 08:00:27:7B:B4:3A (Oracle VirtualBox virtual NIC)
...
SF-Port443-TCP:V=7.94SVN%T=SSL%I=7%D=9/25%Time=66F4BD9E%P=x86_64-pc-linux-
SF:gnu%r(HTTPOptions,12B,"HTTP/1\.1\x20501\x20Not\x20Implemented\r\nDate:\
SF:x20Thu,\x2026\x20Sep\x202024\x2001:49:18\x20GMT\r\nConnection:\x20close
SF:\r\nContent-Security-Policy:\x20block-all-mixed-content\r\nContent-Type
SF::\x20text/plain;\x20charset=utf-8\r\nStrict-Transport-Security:\x20max-
SF:age=31536000\r\nX-Content-Type-Options:\x20nosniff\r\nX-Frame-Options:\
SF:x20DENY\r\nContent-Length:\x200\r\n\r\n")%r(FourOhFourRequest,125,"HTTP
SF:/1\.1\x20404\x20Not\x20Found\r\nDate:\x20Thu,\x2026\x20Sep\x202024\x200
SF:1:49:18\x20GMT\r\nConnection:\x20close\r\nContent-Security-Policy:\x20b
SF:lock-all-mixed-content\r\nContent-Type:\x20text/plain;\x20charset=utf-8
SF:\r\nStrict-Transport-Security:\x20max-age=31536000\r\nX-Content-Type-Op
SF:tions:\x20nosniff\r\nX-Frame-Options:\x20DENY\r\nContent-Length:\x200\r
SF:\n\r\n")%r(RTSPRequest,B3,"HTTP/1\.1\x20400\x20Bad\x20Request\r\nDate:\
SF:x20Thu,\x2026\x20Sep\x202024\x2001:49:28\x20GMT\r\nConnection:\x20close
SF:\r\nContent-Type:\x20text/html\r\nContent-Length:\x2050\r\n\r\n<HTML><B
SF:ODY><H1>400\x20Bad\x20Request</H1></BODY></HTML>")%r(SIPOptions,B3,"HTT
SF:P/1\.1\x20400\x20Bad\x20Request\r\nDate:\x20Thu,\x2026\x20Sep\x202024\x
SF:2001:50:36\x20GMT\r\nConnection:\x20close\r\nContent-Type:\x20text/html
SF:\r\nContent-Length:\x2050\r\n\r\n<HTML><BODY><H1>400\x20Bad\x20Request<
SF:/H1></BODY></HTML>");
==============NEXT SERVICE FINGERPRINT (SUBMIT INDIVIDUALLY)==============
SF-Port33060-TCP:V=7.94SVN%I=7%D=9/25%Time=66F4BD9D%P=x86_64-pc-linux-gnu%
...
SF:20unserializing\x20protobuf\x20message\"\x05HY000")%r(SIPOptions,9,"\x0
SF:5\0\0\0\x0b\x08\x05\x1a\0")%r(LANDesk-RC,9,"\x05\0\0\0\x0b\x08\x05\x1a\
SF:0")%r(TerminalServer,9,"\x05\0\0\0\x0b\x08\x05\x1a\0")%r(NCP,9,"\x05\0\
SF:0\0\x0b\x08\x05\x1a\0")%r(NotesRPC,2B,"\x05\0\0\0\x0b\x08\x05\x1a\0\x1e
SF:\0\0\0\x01\x08\x01\x10\x88'\x1a\x0fInvalid\x20message\"\x05HY000")%r(Ja
SF:vaRMI,9,"\x05\0\0\0\x0b\x08\x05\x1a\0")%r(WMSRequest,9,"\x05\0\0\0\x0b\
SF:x08\x05\x1a\0")%r(oracle-tns,32,"\x05\0\0\0\x0b\x08\x05\x1a\0%\0\0\0\x0
SF:1\x08\x01\x10\x88'\x1a\x16Invalid\x20message-frame\.\"\x05HY000")%r(ms-
SF:sql-s,9,"\x05\0\0\0\x0b\x08\x05\x1a\0")%r(afp,2B,"\x05\0\0\0\x0b\x08\x0
SF:5\x1a\0\x1e\0\0\0\x01\x08\x01\x10\x88'\x1a\x0fInvalid\x20message\"\x05H
SF:Y000")%r(giop,9,"\x05\0\0\0\x0b\x08\x05\x1a\0");
MAC Address: 0A:00:27:00:00:0F (Unknown)
Service Info: OS: Windows; CPE: cpe:/o:microsoft:windows

Nmap scan report for earth.local (192.168.56.103)
Host is up (0.00097s latency).
Not shown: 65342 filtered tcp ports (no-response), 190 filtered tcp ports (admin-prohibited)
PORT    STATE SERVICE  VERSION
...
Completed Parallel DNS resolution of 1 host. at 21:51, 0.09s elapsed
Initiating SYN Stealth Scan at 21:51
Scanning 192.168.56.102 [65535 ports]
Completed SYN Stealth Scan at 21:51, 0.51s elapsed (65535 total ports)
...
Nmap done: 256 IP addresses (5 hosts up) scanned in 354.45 seconds
           Raw packets sent: 393711 (17.315MB) | Rcvd: 327877 (14.432MB)
