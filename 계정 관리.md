...
: [[암호화]](https://github.com/JJH0204/MyNote/blob/e6dd450f7680d09c73bb8fc98ae6f6a32fc3d820/Encrypted)된 계정 비밀번호가 저장된 파일
...
/etc/shadow 파일에 저장된 패스워드에 적용된 암호화([해싱](https://github.com/JJH0204/MyNote/blob/e6dd450f7680d09c73bb8fc98ae6f6a32fc3d820/Hashing)) 알고리즘 결과에 임의의 문자열을 추가해 같은 비밀번호를 사용하더라도 다른 암호화 결과가 나오도록 하는 기법
...
> [!Real/Effective] Real
> 
> - 사용자 식별에 사용하는 아이디(또는 그룹)
> 
> Effective
> 
> - 사용자의 권한을 식별하는데 사용하는 아이디(또는 그룹)
